...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "feedbackActivitiesQuestion" : MessageLookupByLibrary.simpleMessage("Numărul aproximativ de activități la care ați participat (curs + aplicații):"),
    "feedbackApplicationsQuestion1" : MessageLookupByLibrary.simpleMessage("Cadrul didactic stăpânește bine domeniul de studiu?"),
    "feedbackApplicationsQuestion2" : MessageLookupByLibrary.simpleMessage("Aplicațiile au stimulat discuțiile și cadrul didactic a răspuns clar întrebărilor studenților?"),
    "feedbackApplicationsQuestion3" : MessageLookupByLibrary.simpleMessage("Comportamentul cadrului didactic față de studenți a fost adecvat?"),
    "feedbackApplicationsQuestion4" : MessageLookupByLibrary.simpleMessage("Materialele didactice puse la dispoziție sunt suficiente pentru înțelegerea aplicațiilor?"),
    "feedbackGeneralQuestion1" : MessageLookupByLibrary.simpleMessage("Evaluarea dumneavoastră generală cu privire la această disciplină este pozitivă?"),
    "feedbackGeneralQuestion2" : MessageLookupByLibrary.simpleMessage("Care este nota pe care vă așteptați să o obțineți la această disciplină? (1-10)"),
    "feedbackGeneralQuestion3" : MessageLookupByLibrary.simpleMessage("Încărcarea generală la această disciplină este mai mică decât cea a altor discipline care oferă același număr de credite?"),
    "feedbackGeneralQuestion4" : MessageLookupByLibrary.simpleMessage("Dotarea (locație/echipamente hardware și software/suport digital) este adecvată activităților acestei discipline?"),
    "feedbackHomeworkQuestion1" : MessageLookupByLibrary.simpleMessage("Estimați numărul mediu de ore pe săptămână dedicate rezolvării temelor (un număr între 1 și 10 ore)."),
    "feedbackHomeworkQuestion2" : MessageLookupByLibrary.simpleMessage("Numărul și dificultatea temelor au fost adecvate?"),
    "feedbackHomeworkQuestion3" : MessageLookupByLibrary.simpleMessage("Temele/proiectele/activitățile practice au ajutat la înțelegerea materiei?"),
    "feedbackLectureApplicationsQuestion2" : MessageLookupByLibrary.simpleMessage("Metoda de expunere a fost potrivită?"),
    "feedbackLectureQuestion1" : MessageLookupByLibrary.simpleMessage("Cadrul didactic stăpânește bine domeniul de studiu?"),
    "feedbackLectureQuestion3" : MessageLookupByLibrary.simpleMessage("Cursul a stimulat discuțiile și cadrul didactic a răspuns clar întrebărilor studenților?"),
    "feedbackLectureQuestion4" : MessageLookupByLibrary.simpleMessage("Comportamentul cadrului didactic față de studenți a fost adecvat?"),
    "feedbackLectureQuestion5" : MessageLookupByLibrary.simpleMessage("Materialele didactice puse la dispoziție sunt suficiente pentru înțelegerea cursului?"),
    "feedbackPersonalQuestion1" : MessageLookupByLibrary.simpleMessage("Care sunt aspectele pozitive ale acestei discipline?"),
    "feedbackPersonalQuestion2" : MessageLookupByLibrary.simpleMessage("Ce considerați că trebuie îmbunătățit la această disciplină?"),
    "feedbackPersonalQuestion3" : MessageLookupByLibrary.simpleMessage("După părerea dumneavoastră, dificultatea principală în urmărirea acestei discipline provine din:"),
    "feedbackPersonalQuestion4" : MessageLookupByLibrary.simpleMessage("Alte comentarii personale sau sugestii referitoare la activitățile desfășurate la această disciplină:"),
    ...
    "labelVersion" : MessageLookupByLibrary.simpleMessage("Versiune"),
    ...
    "navigationClassFeedback" : MessageLookupByLibrary.simpleMessage("Formular feedback"),
    ...
    "sectionApplications" : MessageLookupByLibrary.simpleMessage("Aplicații"),
    ...
    "sectionGeneralQuestions" : MessageLookupByLibrary.simpleMessage("Întrebări generale"),
    "sectionGrading" : MessageLookupByLibrary.simpleMessage("Punctaj"),
    "sectionInvolvement" : MessageLookupByLibrary.simpleMessage("Implicare"),
    "sectionPersonalComments" : MessageLookupByLibrary.simpleMessage("Comentarii personale"),
