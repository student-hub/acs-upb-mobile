...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m4(name) => "${name} team";

  static m5(appName) => "Why do you want edit permissions for ${appName}?";

  static m6(email) => "Are you sure you want to change the account email to ${email}?";

  static m7(shortcutName) => "Are you sure you want to delete \"${shortcutName}\"?";

  static m8(name) => "Welcome, ${name}!";

  static m9(email) => "There is already an account associated with ${email}.";

  static m10(n) => "Only ${n} options can be selected at a time.";

  static m11(provider) => "Please log in with ${provider} to continue.";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "feedbackActivitiesQuestion" : MessageLookupByLibrary.simpleMessage("Approximate number of activities that you attended (lectures + applications):"),
    "feedbackApplicationsQuestion1" : MessageLookupByLibrary.simpleMessage("Does the assistant master the field of study well?"),
    "feedbackApplicationsQuestion2" : MessageLookupByLibrary.simpleMessage("Did the applications stimulate discussions and did the assistant clearly answer students\' questions?"),
    "feedbackApplicationsQuestion3" : MessageLookupByLibrary.simpleMessage("Was the assistant\'s behaviour towards students appropriate?"),
    "feedbackApplicationsQuestion4" : MessageLookupByLibrary.simpleMessage("Are the teaching materials provided sufficient to understand the applications?"),
    "feedbackGeneralQuestion1" : MessageLookupByLibrary.simpleMessage("Is your overall assessment of this discipline positive?"),
    "feedbackGeneralQuestion2" : MessageLookupByLibrary.simpleMessage("What grade do you expect to get in this class? (1-10)"),
    "feedbackGeneralQuestion3" : MessageLookupByLibrary.simpleMessage("Is the overall load in this class lower than in other classes that offer the same number of credits?"),
    "feedbackGeneralQuestion4" : MessageLookupByLibrary.simpleMessage("Is the endowment (location / hardware and software / digital support) adequate for the activities of this discipline?"),
    "feedbackHomeworkQuestion1" : MessageLookupByLibrary.simpleMessage("Estimate the average number of hours per week devoted to solving homework (between 1 and 10 hours)."),
    "feedbackHomeworkQuestion2" : MessageLookupByLibrary.simpleMessage("Were the number and difficulty of the homework adequate?"),
    "feedbackHomeworkQuestion3" : MessageLookupByLibrary.simpleMessage("Did the homework / projects / practical activities help to understand the class?"),
    "feedbackLectureApplicationsQuestion2" : MessageLookupByLibrary.simpleMessage("Was the exposure method appropriate?"),
    "feedbackLectureQuestion1" : MessageLookupByLibrary.simpleMessage("Does the teacher master the field of study well?"),
    "feedbackLectureQuestion3" : MessageLookupByLibrary.simpleMessage("Did the lecture stimulate discussions and did the teacher clearly answer students\' questions?"),
    "feedbackLectureQuestion4" : MessageLookupByLibrary.simpleMessage("Was the teacher\'s behaviour towards students appropriate?"),
    "feedbackLectureQuestion5" : MessageLookupByLibrary.simpleMessage("Are the teaching materials provided sufficient to understand the lecture?"),
    "feedbackPersonalQuestion1" : MessageLookupByLibrary.simpleMessage("What are the positive aspects of this class?"),
    "feedbackPersonalQuestion2" : MessageLookupByLibrary.simpleMessage("What do you think needs to be improved in this class?"),
    "feedbackPersonalQuestion3" : MessageLookupByLibrary.simpleMessage("In your opinion, the main difficulty in pursuing this class comes from:"),
    "feedbackPersonalQuestion4" : MessageLookupByLibrary.simpleMessage("Other personal comments or suggestions regarding the activities carried out in this discipline:"),
    ...
    "sectionApplications" : MessageLookupByLibrary.simpleMessage("Applications"),
    ...
    "sectionGeneralQuestions" : MessageLookupByLibrary.simpleMessage("General questions"),
    "sectionGrading" : MessageLookupByLibrary.simpleMessage("Grading"),
    "sectionInvolvement" : MessageLookupByLibrary.simpleMessage("Involvement"),
    "sectionPersonalComments" : MessageLookupByLibrary.simpleMessage("Personal comments"),
