...
class S {
  ...
  String get feedbackGeneralQuestion1 {
    return Intl.message(
      'Is your overall assessment of this discipline positive?',
      name: 'feedbackGeneralQuestion1',
      desc: '',
      args: [],
    );
  }

  /// `What grade do you expect to get in this class? (1-10)`
  String get feedbackGeneralQuestion2 {
    return Intl.message(
      'What grade do you expect to get in this class? (1-10)',
      name: 'feedbackGeneralQuestion2',
      desc: '',
      args: [],
    );
  }

  /// `Is the overall load in this class lower than in other classes that offer the same number of credits?`
  String get feedbackGeneralQuestion3 {
    return Intl.message(
      'Is the overall load in this class lower than in other classes that offer the same number of credits?',
      name: 'feedbackGeneralQuestion3',
      desc: '',
      args: [],
    );
  }

  /// `Is the endowment (location / hardware and software / digital support) adequate for the activities of this discipline?`
  String get feedbackGeneralQuestion4 {
    return Intl.message(
      'Is the endowment (location / hardware and software / digital support) adequate for the activities of this discipline?',
      name: 'feedbackGeneralQuestion4',
      desc: '',
      args: [],
    );
  }
  ...
  String get feedbackActivitiesQuestion {
    return Intl.message(
      'Approximate number of activities that you attended (lectures + applications):',
      name: 'feedbackActivitiesQuestion',
      desc: '',
      args: [],
    );
  }

  /// `Does the teacher master the field of study well?`
  String get feedbackLectureQuestion1 {
    return Intl.message(
      'Does the teacher master the field of study well?',
      name: 'feedbackLectureQuestion1',
      desc: '',
      args: [],
    );
  }

  /// `Was the exposure method appropriate?`
  String get feedbackLectureApplicationsQuestion2 {
    return Intl.message(
      'Was the exposure method appropriate?',
      name: 'feedbackLectureApplicationsQuestion2',
      desc: '',
      args: [],
    );
  }

  /// `Did the lecture stimulate discussions and did the teacher clearly answer students' questions?`
  String get feedbackLectureQuestion3 {
    return Intl.message(
      'Did the lecture stimulate discussions and did the teacher clearly answer students\' questions?',
      name: 'feedbackLectureQuestion3',
      desc: '',
      args: [],
    );
  }

  /// `Was the teacher's behaviour towards students appropriate?`
  String get feedbackLectureQuestion4 {
    return Intl.message(
      'Was the teacher\'s behaviour towards students appropriate?',
      name: 'feedbackLectureQuestion4',
      desc: '',
      args: [],
    );
  }

  /// `Are the teaching materials provided sufficient to understand the lecture?`
  String get feedbackLectureQuestion5 {
    return Intl.message(
      'Are the teaching materials provided sufficient to understand the lecture?',
      name: 'feedbackLectureQuestion5',
      desc: '',
      args: [],
    );
  }

  /// `Does the assistant master the field of study well?`
  String get feedbackApplicationsQuestion1 {
    return Intl.message(
      'Does the assistant master the field of study well?',
      name: 'feedbackApplicationsQuestion1',
      desc: '',
      args: [],
    );
  }

  /// `Did the applications stimulate discussions and did the assistant clearly answer students' questions?`
  String get feedbackApplicationsQuestion2 {
    return Intl.message(
      'Did the applications stimulate discussions and did the assistant clearly answer students\' questions?',
      name: 'feedbackApplicationsQuestion2',
      desc: '',
      args: [],
    );
  }

  /// `Was the assistant's behaviour towards students appropriate?`
  String get feedbackApplicationsQuestion3 {
    return Intl.message(
      'Was the assistant\'s behaviour towards students appropriate?',
      name: 'feedbackApplicationsQuestion3',
      desc: '',
      args: [],
    );
  }

  /// `Are the teaching materials provided sufficient to understand the applications?`
  String get feedbackApplicationsQuestion4 {
    return Intl.message(
      'Are the teaching materials provided sufficient to understand the applications?',
      name: 'feedbackApplicationsQuestion4',
      desc: '',
      args: [],
    );
  }

  /// `Estimate the average number of hours per week devoted to solving homework (between 1 and 10 hours).`
  String get feedbackHomeworkQuestion1 {
    return Intl.message(
      'Estimate the average number of hours per week devoted to solving homework (between 1 and 10 hours).',
      name: 'feedbackHomeworkQuestion1',
      desc: '',
      args: [],
    );
  }

  /// `Were the number and difficulty of the homework adequate?`
  String get feedbackHomeworkQuestion2 {
    return Intl.message(
      'Were the number and difficulty of the homework adequate?',
      name: 'feedbackHomeworkQuestion2',
      desc: '',
      args: [],
    );
  }

  /// `Did the homework / projects / practical activities help to understand the class?`
  String get feedbackHomeworkQuestion3 {
    return Intl.message(
      'Did the homework / projects / practical activities help to understand the class?',
      name: 'feedbackHomeworkQuestion3',
      desc: '',
      args: [],
    );
  }
  ...
  String get feedbackPersonalQuestion1 {
    return Intl.message(
      'What are the positive aspects of this class?',
      name: 'feedbackPersonalQuestion1',
      desc: '',
      args: [],
    );
  }

  /// `What do you think needs to be improved in this class?`
  String get feedbackPersonalQuestion2 {
    return Intl.message(
      'What do you think needs to be improved in this class?',
      name: 'feedbackPersonalQuestion2',
      desc: '',
      args: [],
    );
  }

  /// `In your opinion, the main difficulty in pursuing this class comes from:`
  String get feedbackPersonalQuestion3 {
    return Intl.message(
      'In your opinion, the main difficulty in pursuing this class comes from:',
      name: 'feedbackPersonalQuestion3',
      desc: '',
      args: [],
    );
  }

  /// `Other personal comments or suggestions regarding the activities carried out in this discipline:`
  String get feedbackPersonalQuestion4 {
    return Intl.message(
      'Other personal comments or suggestions regarding the activities carried out in this discipline:',
      name: 'feedbackPersonalQuestion4',
      desc: '',
      args: [],
    );
  }
